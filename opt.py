...
parser.add_argument('--t_l', type=int, default=2, help="filtering time of Laplacian filters")
parser.add_argument('--t_m', type=int, default=2, help="filtering time of Laplacian filters")
parser.add_argument('--sigma', type=float, default=0.001, help='Sigma of gaussian distribution')
parser.add_argument('--mask_ratio', type=float, default=0.005, help='mask_ratio')

# network
parser.add_argument('--beta', type=float, default=1, help='focusing factor beta')
parser.add_argument('--gama', type=float, default=1, help='focusing factor gama')
...
parser.add_argument('--tao_l', type=float, default=0.9, help='high confidence rate')
